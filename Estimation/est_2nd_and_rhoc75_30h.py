...
def main(argv):
    ...
    rhoc_1 = 92.48       # 67.58 (-5%); 71.14; 74.70 (+5%); 78.25 (+10%); 85.37 (+20%); 92.48 (+30%); 99.60 (+40%)
    rhoc_10 = 99.15       # 72.46 (-5%); 76.27; 80.08 (+5%); 83.90 (+10%); 91.52 (+20%); 99.15 (+30%); 106.78 (+40%)
    rhoc_20 = 108.9       # 79.58 (-5%); 83.77; 87.96 (+5%); 92.15 (+10%); 100.52 (+20%); 108.9 (+30%); 117.28 (+40%)
    rhoc_25 = 112.54       # 82.24 (-5%); 86.57; 90.90 (+5%); 95.23 (+10%); 103.88 (+20%); 112.54 (+30%); 121.20 (+40%)
    rhoc_30 = 118.60       # 86.67 (-5%); 91.23; 95.79 (+5%); 100.35 (+10%); 109.48 (+20%); 118.60 (+30%); 127.72 (+40%)
    rhoc_40 = 126.79       # 92.65 (-5%); 97.53; 102.41 (+5%); 107.28 (+10%); 117.04 (+20%); 126.79 (+30%); 136.54 (+40%)
    rhoc_50 = 139.92       # 102.25 (-5%); 107.63; 113.01 (+5%); 118.40 (+10%); 129.16 (+20%); 139.92 (+30%); 150.68 (+40%)
    rhoc_60 = 151.91       # 111.01 (-5%); 116.85; 122.69 (+5%); 128.54 (+10%); 140.22 (+20%); 151.91 (+30%); 163.59 (+40%)
    rhoc_70 = 175.05       # 127.92 (-5%); 134.65; 141.38 (+5%); 148.12 (+10%); 161.58 (+20%); 175.05 (+30%); 188.51 (+40%)
    rhoc_75 = 189.32       # 138.35 (-5%); 145.63; 152.91 (+5%); 160.19 (+10%); 174.76 (+20%); 189.32 (+30%); 203.88 (+40%)
    rhoc_80 = 197.03       # 143.98 (-5%); 151.56; 159.14 (+5%); 166.72 (+10%); 181.87 (+20%); 197.03 (+30%); 212.18 (+40%)
    rhoc_90 = 238.21       # 174.08 (-5%); 183.24; 192.40 (+5%); 201.56 (+10%); 219.89 (+20%); 238.21 (+30%); 256.54 (+40%)
    rhoc_99 = 279.45       # 203.36 (-5%); 214.06; 224.76 (+5%); 235.47 (+10%); 256.87 (+20%); 279.45 (+30%); 300.94 (+40%)
    rhoc_100 = 279.45       # 203.36 (-5%); 214.06; 224.76 (+5%); 235.47 (+10%); 256.87 (+20%); 279.45 (+30%); 300.94 (+40%)
    ...
    rhoc_55 = 85.38
    rhoc_65 = 88.81
    rhoc_75 = 120.82         # 88.3 (-5%); 92.94; 97.59 (+5%); 120.82 (+30%); 130.12 (+40%)
    rhoc_85 = 98.28
    rhoc_95 = 105.8
    ...
    for sample in samples:
        ...
        for i in range(0, 10):
            ...
            directorySave = os.getcwd() + '/Result/SA/Est_2nd_and_rhoc75_30h_{0}/'.format(i)
