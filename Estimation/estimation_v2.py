...
def run_estimators(fdpNB, rhoc1st, directoryLoad, directorySave):
    ...
    for PR in PRsetTest:
        ...
        #                    print 'this is time step',k
                    ...
                    ## PF            
                        ...
                        likelihood, hasMeasurement = compute_likelihood(state, densityMea, densityMeaMean,densityMeaStd, sample, sensorLocation)
...
rhom_all = 644
#rhom_all = 460
vmax_all = 75.94    # 72.14 (-5%), 75.94, 79.74 (+5%)
beta = 600
...
rhoc_0 = 75.03          # 67.89 (-5%); 71.46; 75.03
rhoc_5 = 72.31
rhoc_15 = 74.31
rhoc_25 = 77.11
rhoc_35 = 80.23
...
directorySave = os.getcwd()+'/Result/Estimation_1st_rhoc_0_5higher/'

t_start = time.time()

run_estimators(fdpNB, rhoc1st, directoryLoad, directorySave)
