...
def main(argv):
    ...
    directoryLoadPrefix = os.getcwd() + '/Result/Estimation_corrected_1st_rhoc0_5h_'
    directoryLoad = os.getcwd() + '/Result/Estimation_corrected_1st_rhoc0_5h/'
    directorySave = os.getcwd() + '/Result/Estimation_corrected_1st_rhoc0_5h/'
    savename = '0_1st_rhoc0_5h_'
