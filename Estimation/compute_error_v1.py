...
def main(argv):
    ...
    directoryLoadPrefix = os.getcwd() + '/Result/Estimation_old_1_'

    directorySave = os.getcwd() + '/Result/Estimation_old_1_figs/'
    savename = 'old_1_seed24232_'
    ...
    #                   colors, 'Average estimation error', 'error_seed_all')
    #
    # scatter_seeds_err(directorySave, PRsetTest, sensorLocationSeed,
    #                   error_array_1st_ff, 0, '1st free flow',
    #                   error_array_2nd_ff, 0, '2nd free flow',
    #                   colors, 'Average estimation error in free flow', 'error_seed_ff')
    #
    # scatter_seeds_err(directorySave, PRsetTest, sensorLocationSeed,
    #                   error_array_1st_cf, 0, '1st congested flow',
    #                   error_array_2nd_cf, 0, '2nd congested flow',
    #                   colors, 'Average estimation error in congested flow', 'error_seed_cf')
    ...
    #                            perc_improv_all, 0, colors, 'Improvemnt of 2nd over 1st', 'err_perc_all')
    #
    # scatter_seeds_perc_improve(directorySave, PRsetTest, sensorLocationSeed,
    #                            perc_improv_ff, 0, colors, 'Improvemnt of 2nd over 1st in free flow', 'err_perc_ff')
    #
    # scatter_seeds_perc_improve(directorySave, PRsetTest, sensorLocationSeed,
    #                            perc_improv_cf, 0, colors, 'Improvemnt of 2nd over 1st in congested flow', 'err_perc_cf')
