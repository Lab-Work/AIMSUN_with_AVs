...
def main(argv):
    ...
    rhoc_0 = 67.58       # 67.58 (-5%); 71.14; [71.14 <==74.70 (+5%) ]
    rhoc_1 = 67.58       # 67.58 (-5%); 71.14; 74.70 (+5%)
    rhoc_10 = 72.46       # 72.46 (-5%); 76.27; 80.08 (+5%)
    rhoc_20 = 79.58       # 79.58 (-5%); 83.77; 87.96 (+5%)
    rhoc_25 = 82.24       # 82.24 (-5%); 86.57; 90.90 (+5%)
    rhoc_30 = 86.67       # 86.67 (-5%); 91.23; 95.79 (+5%)
    rhoc_40 = 92.65       # 92.65 (-5%); 97.53; 102.41 (+5%)
    rhoc_50 = 102.25       # 102.25 (-5%); 107.63; 113.01 (+5%)
    rhoc_60 = 111.01       # 111.01 (-5%); 116.85; 122.69 (+5%)
    rhoc_70 = 127.92       # 127.92 (-5%); 134.65; 141.38 (+5%)
    rhoc_75 = 138.35       # 138.35 (-5%); 145.63; 152.91 (+5%)
    rhoc_80 = 143.98       # 143.98 (-5%); 151.56; 159.14 (+5%)
    rhoc_90 = 174.08       # 174.08 (-5%); 183.24; 192.40 (+5%)
    rhoc_99 = 203.36       # 203.36 (-5%); 214.06; 224.76 (+5%)
    rhoc_100 = 203.36       # 203.36 (-5%); 214.06; 224.76 (+5%)
    ...
    for sample in samples:
        ...
        for i in range(0, 10):
            ...
            directorySave = os.getcwd() + '/Result/SA/Est_2nd_5l_{0}/'.format(i)
