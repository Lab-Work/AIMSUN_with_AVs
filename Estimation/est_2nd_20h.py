...
def main(argv):
    ...
    rhoc_1 = 85.37       # 67.58 (-5%); 71.14; 74.70 (+5%); 78.25 (+10%); 85.37 (+20%)
    rhoc_10 = 91.52       # 72.46 (-5%); 76.27; 80.08 (+5%); 83.90 (+10%); 91.52 (+20%)
    rhoc_20 = 100.52       # 79.58 (-5%); 83.77; 87.96 (+5%); 92.15 (+10%); 100.52 (+20%)
    rhoc_25 = 103.88       # 82.24 (-5%); 86.57; 90.90 (+5%); 95.23 (+10%); 103.88 (+20%)
    rhoc_30 = 109.48       # 86.67 (-5%); 91.23; 95.79 (+5%); 100.35 (+10%); 109.48 (+20%)
    rhoc_40 = 117.04       # 92.65 (-5%); 97.53; 102.41 (+5%); 107.28 (+10%); 117.04 (+20%)
    rhoc_50 = 129.16       # 102.25 (-5%); 107.63; 113.01 (+5%); 118.40 (+10%); 129.16 (+20%)
    rhoc_60 = 140.22       # 111.01 (-5%); 116.85; 122.69 (+5%); 128.54 (+10%); 140.22 (+20%)
    rhoc_70 = 161.58       # 127.92 (-5%); 134.65; 141.38 (+5%); 148.12 (+10%); 161.58 (+20%)
    rhoc_75 = 174.76       # 138.35 (-5%); 145.63; 152.91 (+5%); 160.19 (+10%); 174.76 (+20%)
    rhoc_80 = 181.87       # 143.98 (-5%); 151.56; 159.14 (+5%); 166.72 (+10%); 181.87 (+20%)
    rhoc_90 = 219.89       # 174.08 (-5%); 183.24; 192.40 (+5%); 201.56 (+10%); 219.89 (+20%)
    rhoc_99 = 256.87       # 203.36 (-5%); 214.06; 224.76 (+5%); 235.47 (+10%); 256.87 (+20%)
    rhoc_100 = 256.87       # 203.36 (-5%); 214.06; 224.76 (+5%); 235.47 (+10%); 256.87 (+20%)
    ...
    for sample in samples:
        ...
        for i in range(0, 10):
            ...
            directorySave = os.getcwd() + '/Result/SA/Est_2nd_20h_{0}/'.format(i)
