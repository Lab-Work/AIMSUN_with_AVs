...
def main(argv):
    ...
    directoryLoadPrefix = os.getcwd() + '/Result/Estimation_corrected_1st_rhoc50_5l_'
    directoryLoad = os.getcwd() + '/Result/Estimation_corrected_1st_rhoc50_5l/'
    directorySave = os.getcwd() + '/Result/Estimation_corrected_1st_rhoc50_5l/'
    savename = '0_1st_rhoc50_5l_'
