...
def main(argv):
    ...
    directoryLoadPrefix = os.getcwd() + '/Result/Estimation_corrected_1st_rhoc50_5h_'
    directoryLoad = os.getcwd() + '/Result/Estimation_corrected_1st_rhoc50_5h/'
    directorySave = os.getcwd() + '/Result/Estimation_corrected_1st_rhoc50_5h/'
    savename = '0_1st_rhoc50_5h_'
