...
def main(argv):
    ...
    directoryLoadPrefix = os.getcwd() + '/Result/Estimation_corrected_rhom_5l_'
    directoryLoad = os.getcwd() + '/Result/Estimation_corrected_rhom_5l/'
    directorySave = os.getcwd() + '/Result/Estimation_corrected_rhom_5l/'
    savename = '0_rhom_5l_'
